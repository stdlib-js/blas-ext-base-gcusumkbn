...
tape( 'the function supports an `x` stride (accessors)', function test( t ) {
	...
	gcusumkbn( 3, 0.0, toAccessorArray( x ), 2, 0, toAccessorArray( y ), 1, 0 );
...
tape( 'the function supports a `y` stride', function test( t ) {
	...
	gcusumkbn( 3, 0.0, toAccessorArray( x ), 1, 0, toAccessorArray( y ), 2, 0 );
...
tape( 'the function supports negative strides', function test( t ) {
	...
	gcusumkbn( 3, 0.0, x, -2, x.length-1, y, -1, 2 );
...
tape( 'the function supports negative strides (accessors)', function test( t ) {
	...
	gcusumkbn( 3, 0.0, toAccessorArray( x ), -2, x.length-1, toAccessorArray( y ), -1, 2 );
...
tape( 'the function supports an `x` offset (accessors)', function test( t ) {
	...
	gcusumkbn( 4, 0.0, toAccessorArray( x ), 2, 1, toAccessorArray( y ), 1, 0 );
...
tape( 'the function supports a `y` offset (accessors)', function test( t ) {
	...
	gcusumkbn( 4, 0.0, toAccessorArray( x ), 1, 0, toAccessorArray( y ), 2, 1 );
